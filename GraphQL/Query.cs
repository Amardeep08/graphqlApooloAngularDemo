...
namespace CommanderGQL.GraphQL
{
    ...
    public class Query
    {
        ...
        [UseSorting]
        [GraphQLDescription("Gets the queryable command.")]
        public IQueryable<Command> UpdateCommand([ScopedService] AppDbContext context,Command command)
        {
            return context.Commands;
        }
        ...
        [GraphQLDescription("Gets the queryable platform.")]
        public IQueryable<Platform> UpdatePlatform([ScopedService] AppDbContext context,Platform platform)
        {
            return context.Platforms;
        }
